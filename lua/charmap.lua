-- Gen III "international" text encoding table, shared by English, German,
-- French, Spanish, and Italian releases (Japanese uses a different table,
-- not needed here). Vendored from Ironmon-Tracker's GameSettings.lua
-- (GameCharMap), MIT licensed. Covers German umlauts (Ä/Ö/Ü/ä/ö/ü/ß).
local CharMap = {
	[0x00] = ' ',
	...
	[0x2D] = '&', [0x2E] = '+',
	[0x34] = 'LV', [0x35] = '=', [0x36] = ';',
	[0x51] = '¿', [0x52] = '¡', [0x53] = 'PK', [0x54] = 'MN', [0x55] = 'PO',
	[0x56] = 'KE', [0x57] = 'BL', [0x58] = 'OC', [0x59] = 'K', [0x5A] = 'Í',
	[0x5B] = '%', [0x5C] = '(', [0x5D] = ')',
	[0x68] = 'â', [0x6F] = 'í',
	[0x85] = '<', [0x86] = '>',
